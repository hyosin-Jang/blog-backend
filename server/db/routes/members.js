...
router.post("/",(req,res)=>{
    ...
    var params=[req.body.m_id,req.body.m_email,req.body.m_verified_email,req.body.m_picture,req.body.m_hd];
...
router.put("/:m_id",(req,res)=>{
    var sql = 'UPDATE members SET m_email='+req.body.m_email+', m_picture='+req.body.m_picture+', m_hd='+req.body.m_hd+' WHERE m_id=\''+req.params.m_id+"\'";
